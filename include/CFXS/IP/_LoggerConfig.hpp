...
namespace CFXS::IP {
    ...
    public:
        ...
        static constexpr const char* LOG_PREFIX         = "CFXS-IP| ";
        ...
        static constexpr const char* CONSTRUCTOR_PREFIX = __ANSI_CYAN__ "[C] ";
        static constexpr const char* DESTRUCTOR_PREFIX  = __ANSI_CYAN__ "[~] ";
